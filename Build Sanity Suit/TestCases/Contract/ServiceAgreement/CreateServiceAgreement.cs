    ...
    public class A6_CreateServiceAgreement
    {
        ...
        public void A6_CreateService()
        {
            ...
            var GeneralCreate = new Action(() =>
            {
                ...
                HelperFunction.Lookup("mzk_payer", ServiceAgreementData.payer, xrmApp, client);
                xrmApp.ThinkTime(500);
                HelperFunction.Lookup("mzk_provider", ServiceAgreementData.provider, xrmApp, client);
                xrmApp.ThinkTime(500);
                HelperFunction.Lookup("mzk_mastercontractagreement", ServiceAgreementData.mastercontractagreement, xrmApp, client);
                xrmApp.ThinkTime(500);
                HelperFunction.Lookup("mzk_subcontract", ServiceAgreementData.subcontract, xrmApp, client);
                xrmApp.ThinkTime(500);
                HelperFunction.Lookup("mzk_service", ServiceAgreementData.service, xrmApp, client);
                xrmApp.ThinkTime(500);
                HelperFunction.Lookup("mzk_contractsubtype", ServiceAgreementData.contractsubtype, xrmApp, client);
                // xrmApp.ThinkTime(2000);
            ...
            var OtherInformation = new Action(() =>
            {
                ...
                xrmApp.ThinkTime(1000);
                HelperFunction.Lookup("mzk_dispensinglocationwarehouse", ServiceAgreementData.dispensinglocationwarehouse, xrmApp, client);
                ...
                xrmApp.ThinkTime(1000);
                HelperFunction.Lookup("mzk_orderreleasetype", ServiceAgreementData.orderreleasetype, xrmApp, client);
                // xrmApp.ThinkTime(2000);
